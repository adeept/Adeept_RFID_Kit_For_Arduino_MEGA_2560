/***********************************************************
File name: 32_RFIDIdentificationSystem.ino
Description: when you close the ID card to the RFID reader,
             the buzzer will sound, and the ID number will 
             be sent to the serial monitor, and it will be 
             also displayed on the LCD1602.
...
void loop()
{
    ...
    lcd.print("adeeptID        ");// Print a message of "Temp: "to the LCD.
    ...
    if (status == MI_OK)
    {
        ...
        lcd.setCursor(8, 0);
        int lcdid=4;
        for(int i=0; i<lcdid; i++){
            lcd.print(0x0F & (id[i]>>4), HEX);
            lcd.print(0x0F & id[i],HEX);
        }
        if( id[0]==0x14 && id[1]==0x68 && id[2]==0x09 && id[3]==0x6F ) {
            Serial.println("Hello Mary!     ");
            lcd.setCursor(0, 1); // set the cursor to column 0, line 0
            lcd.print("  Hello Mary!   ");// Print a message of "Temp: "to the LCD.
        } else if(id[0]==0x03 && id[1]==0xA2 && id[2]==0x67 && id[3]==0x00) {
            Serial.println("Hello Tom!      ");
            lcd.setCursor(0, 1); // set the cursor to column 0, line 0
            lcd.print("   Hello Tom!   ");// Print a message of "Temp: "to the LCD.
        }else{
            Serial.println("Hello unkown guy");
            lcd.setCursor(0, 1); // set the cursor to column 0, line 0
            lcd.print("Hello unkown guy!");// Print a message of "Temp: "to the LCD.
        }
      //   lcd.print(id[0],HEX);// Print a centigrade temperature to the LCD.
      //   lcd.print(id[1],HEX);// Print a centigrade temperature to the LCD.
      //   lcd.print(id[2],HEX);// Print a centigrade temperature to the LCD.
      //   lcd.print(id[3],HEX);// Print a centigrade temperature to the LCD.
    }
